...
export const metadata: Metadata = {
  title: "Grandeur Hotel - Luxury Accommodations & 5-Star Service",
  description: "Experience unparalleled luxury at Grandeur Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, spa, fine dining, business hotel",
  openGraph: {
    title: "Grandeur Hotel - Luxury Accommodations & 5-Star Service",
    ...
    images: [{
      ...
      alt: "Luxurious hotel lobby interior"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Grandeur Hotel - Luxury Accommodations & 5-Star Service",
    description: "Experience unparalleled luxury at Grandeur Hotel with premium rooms and exceptional service.",
